                ...
                ApiService.apiService.suadiachi(username,fullname,phone,address).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (message.equals("Success")){
                            ...
                            ThongTinActivity.fullname.setText(user1.getFullname());
                            ThongTinActivity.phone.setText(user1.getPhone());
                            ThongTinActivity.address.setText(user1.getAddress());
                            finish();
                        }else {
                            Toast.makeText(SuaThongTinActivity.this, "Fail", Toast.LENGTH_SHORT).show();
                        }
                    }
...
//                        Log.e("DIA",t.getMessage());
                        Toast.makeText(SuaThongTinActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });

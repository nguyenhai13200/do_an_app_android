...
public class ChitietIphoneActivity extends AppCompatActivity {
    ...
    private void GetInFormation() {
        ...
        iphone = (Iphone) bundle.get("thongtiniphone");
        id = iphone.getId();
        TenChitiet = iphone.getTen();
        GiaChitiet = iphone.getGia();
        HinhanhChitiet = iphone.getHinhanh();
        MotaChitiet = iphone.getMota();
    ...
    private void GetImageChitietIP() {
        ApiService.apiService.getImageChitietIP(id).enqueue(new Callback<ArrayList<ImageChitiet>>() {
            @Override
            ...
            public void onFailure(Call<ArrayList<ImageChitiet>> call, Throwable t) {
                Toast.makeText(ChitietIphoneActivity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
    }

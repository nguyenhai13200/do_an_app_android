...
public class ChitietSanphamNewActivity extends AppCompatActivity {
    ...
    private void GetInFormation() {
        ...
        sanphamNew = (SanphamNew) bundle.get("thongtinspn");
        id = sanphamNew.getId();
        TenChitiet = sanphamNew.getTenspn();
        GiaChitiet = sanphamNew.getGiaspn();
        HinhanhChitiet = sanphamNew.getHinhanhspn();
        MotaChitiet = sanphamNew.getMotaspn();
    ...
    private void GetImageChitietSpn() {
        ApiService.apiService.getImageChitietSpn(TenChitiet).enqueue(new Callback<ArrayList<ImageChitiet>>() {
            ...
            public void onFailure(Call<ArrayList<ImageChitiet>> call, Throwable t) {
                Toast.makeText(ChitietSanphamNewActivity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
    }

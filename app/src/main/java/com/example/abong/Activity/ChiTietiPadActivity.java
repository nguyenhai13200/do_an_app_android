...
public class ChiTietiPadActivity extends AppCompatActivity {
    ...
    private void GetInFormation() {
        ...
        Ipad ipad = (Ipad) bundle.get("thongtinipad");
        id = ipad.getId();
        TenChitiet = ipad.getTen();
        GiaChitiet = ipad.getGia();
        HinhanhChitiet = ipad.getHinhanh();
        MotaChitiet = ipad.getMota();
    ...
    private void GetImageChitietIpad() {
        ApiService.apiService.getImageChitietIpad(id).enqueue(new Callback<ArrayList<ImageChitiet>>() {
            @Override
            ...
            public void onFailure(Call<ArrayList<ImageChitiet>> call, Throwable t) {
                Toast.makeText(ChiTietiPadActivity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
    }

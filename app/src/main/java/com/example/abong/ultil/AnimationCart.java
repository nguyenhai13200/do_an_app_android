package com.example.abong.ultil;
...
public class AnimationCart {
    private static int ANIMATION_DURUTION = 1000;
    private static boolean isAnimationStart;

    public static void translateAnimation( ImageView viewAnimation, View startView, View endView,
        ...
        float fromY = startPos[1] - startViewWidthCenter;
        ...
        ScaleAnimation startScaleAnimation = new ScaleAnimation(1.0f, 1.5f,
                1.0f,1.5f, startViewWidthCenter, startViewHeightCenter);
